...
class RoutesResolver {
    constructor(container, expressAdapter, config) {
        ...
        this.routerBuilder = new router_explorer_1.ExpressRouterExplorer(new metadata_scanner_1.MetadataScanner(), this.routerProxy, expressAdapter, this.routerExceptionsFilter, config);
    }
    resolve(express) {
