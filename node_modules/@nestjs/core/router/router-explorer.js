...
class ExpressRouterExplorer {
    constructor(metadataScanner, routerProxy, expressAdapter, exceptionsFilter, config) {
        ...
        this.executionContextCreator = new router_execution_context_1.RouterExecutionContext(new route_params_factory_1.RouteParamsFactory(), new pipes_context_creator_1.PipesContextCreator(config), new pipes_consumer_1.PipesConsumer());
    }
    explore(instance, metatype) {
    ...
    applyPathsToRouterProxy(router, routePaths, instance) {
    ...
    applyCallbackToRouter(router, pathProperties, instance) {
    ...
    createCallbackProxy(instance, callback) {
